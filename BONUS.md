Able to update listing availabilities in edit listing
createlisting uses context to enable a seamless multipage listing creation
2.3.2 - Search filters can filter on multiple criteria (similar to AirBnb's implementation). In addition, you can search
by both ascending and descending review rating.
